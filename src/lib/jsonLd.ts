...
export function generateBlogListJsonLd(posts: BlogPost[], baseUrl: string) {
  return {
    '@context': 'https://schema.org',
    '@type': 'Blog',
    name: 'Blog - Mahabbatussholihin Tour & Travel',
    description: 'Tips perjalanan, panduan destinasi, dan artikel wisata dari Mahabbatussholihin Tour & Travel',
    url: `${baseUrl}/blog`,
    publisher: {
      '@type': 'Organization',
      name: 'Mahabbatussholihin Tour & Travel',
