        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary text-white py-3 px-6 rounded-lg font-medium hover:bg-primary-dark transition-colors duration-200 focus:ring-2 focus:ring-primary focus:ring-offset-2"
              >
                Send Message
              </button>
            </form>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h3 className="text-lg font-medium text-black">Office Address</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-700 mt-1">+62 811 1000 2477</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <p className="text-gray-700 mb-4">
                ...
                to your travel inquiries.
              </p>
              <a
                href="https://wa.me/628111000247"
                target="_blank"
